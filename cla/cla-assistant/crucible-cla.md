<!-- Harmony Individual Contributor License Agreement (HA-CLA-I) v1.0, 4 July 2011,
     harmonyagreements.org, CC-BY 3.0. This is the template with The Dark Factory Ltd's
     fills applied: project name, submission and non-owner pointers, Outbound Licence
     OPTION FIVE (Options One to Four deleted), media licence CC BY 4.0, governing law
     England and Wales, and the optional [or Your Affiliates] text DELETED (individual).
     Text extracted from the original PDF programmatically and substituted programmatically;
     no clause was retyped by hand. The unmodified original is ha-cla-i.pdf beside this file. -->

Harmony Individual Contributor License Agreement

Thank you for your interest in contributing to Crucible, a project of The Dark Factory Ltd ("We" or "Us").
...
submission, following the instructions at https://github.com/the-dark-factory/Crucible_AGPL (see CONTRIBUTING.md). This is a legally binding
...
please follow the instructions in CONTRIBUTING.md in the project repository.
...
(b) To the maximum extent permitted by the relevant law, You grant to Us a perpetual, worldwide, non-
exclusive, transferable, royalty-free, irrevocable license under the Copyright covering the Contribution,
...
(Option Five) Based on the grant of rights in Sections 2.1 and 2.2, if We include Your Contribution in a
...
Creative Commons Attribution 4.0 International (CC BY 4.0) (including any right to adopt any future version of a license if
permitted).
...
(d) You have followed the instructions in CONTRIBUTING.md in the project repository, if You do not own the
...
England and Wales excluding its conflicts of law provisions. Under certain circumstances, the
